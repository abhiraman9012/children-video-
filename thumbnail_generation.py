    ...
    try:
        ...
        try:
            ...
            if font_path:
                ...
                print("u26a0ufe0f Could not find a suitable font, using basic text overlay")
            ...
            print(f"u26a0ufe0f Error with font rendering: {font_error}")
        ...
        print(f"u2705 Thumbnail generated and saved to: {thumbnail_path}")

        return thumbnail_path

    except Exception as e:
        print(f"u26a0ufe0f Error generating thumbnail: {e}")
        return None
